...
Instead, report them privately via GitHub's [**Report a vulnerability**](https://github.com/asphum/svelora/security/advisories/new) form (repository **Security** tab → **Report a vulnerability**). This keeps the details private until a fix is released.

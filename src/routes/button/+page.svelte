...
<a href="#Leading--Trailing-Icon" class="group relative inline-flex items-center no-underline hover:underline focus:outline-none focus-visible:underline w-fit">
    ...
    <section class="space-y-3">
        ...
        <p class="text-sm text-on-surface-variant">
            Use the <code class="rounded bg-surface-container-highest px-1">circle</code> prop for a
            fully rounded icon button. It functions similarly to
            <code class="rounded bg-surface-container-highest px-1">square</code> but applies
            <code class="rounded bg-surface-container-highest px-1">rounded-full</code>.
        </p>
        <div class="flex flex-wrap items-end gap-3 rounded-lg bg-surface-container-high p-4">
            {#each sizes as size (size)}
            ...
            {/each}
            <span class="mx-2 text-on-surface-variant">|</span>
            <Button variant="outline" color="secondary" icon="lucide:settings" circle />
            <Button variant="soft" color="success" icon="lucide:check" circle />
            <Button variant="subtle" color="warning" icon="lucide:alert-triangle" circle />

...
import type { EditorSlots, EditorVariantProps } from './editor.variants.js'
...
/**
 * Props for the Editor component (sub-export `svelora/editor`).
 *
...
export interface EditorProps
    extends Omit<HTMLAttributes<HTMLElement>, 'class' | 'autofocus' | 'id'> {

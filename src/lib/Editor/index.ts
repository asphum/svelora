/**
 * Svelora Editor — rich-text WYSIWYG built on Tiptap v3 + ProseMirror.
 *
 * ## Installation
 *
 * Tiptap is declared as an optional peer dependency of svelora, so consumers
 * who don't use `<Editor>` pay zero install/bundle cost. When you do use it,
 * install Tiptap alongside svelora:
 *
 * ```bash
 * pnpm add svelora \
 ...
 * ```svelte
 * <script lang="ts">
 *   import { Editor, type EditorApi } from 'svelora/editor'

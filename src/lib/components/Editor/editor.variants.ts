...
export const editorVariants = tv({
    slots: {
        ...
        content: [
            ...
            '[&_.ps-editor-mention]:inline-flex [&_.ps-editor-mention]:items-center',
            '[&_.ps-editor-mention]:rounded [&_.ps-editor-mention]:bg-primary-container/60',
            '[&_.ps-editor-mention]:text-on-primary-container',
            '[&_.ps-editor-mention]:px-1.5 [&_.ps-editor-mention]:py-0.5',
            '[&_.ps-editor-mention]:text-sm [&_.ps-editor-mention]:font-medium',

...
- implement responsive sizing variants for LocaleButton components

## [3.2.5] - 2026-07-21

### Added

- add conditional width styling to LocaleButton dropdown via ui prop

## [3.2.4] - 2026-07-21

### Added

- improve PasswordInput masking logic and add support for name attribute with hidden input field
...
- remove redundant no-underline classes from anchor tags and export additional types from collapsible index

## [3.2.2] - 2026-07-21

### Added

- add ref binding support to LocaleButton component
...
- add responsiveSize prop to Icon component with CSS variable-based sizing and update documentation accordingly
...
- support custom CSS selectors for sortable handles in SortableList
...
- introduce field name resolution helper and update form components to support array-style naming conventions
...
- implement InputNumber component with variants, testing, and documentation

## [3.0.19] - 2026-06-30

### Changed

- upgrade tailwindcss to version 4.3.2
...
- update all dependencies to latest and remove redundant aria-hidden attribute from SelectMenu input
...
- add notification bell UI, implement Tailwind icon provider, and update modal scrolling documentation.

### Changed

- include JavaScript files in TypeScript project configuration

## [3.0.11] - 2026-06-26

### Added

- add TableBulkActionBar component and automate documentation heading IDs while updating site-wide UI styling
- add NavigationMenu tree support, path matching controls, and migrate top navigation to component-based layout

### Changed

- replace custom sidebar navigation with NavigationMenu and update LocaleButton with flag icons and custom snippets

## [3.0.10] - 2026-06-26

### Changed

- remove unused imports and improve code formatting across library components
...
- implement core UI components and documentation routes for the library
...
- ฟีเจอร์: เพิ่มไลบรารีส่วนประกอบ UI เริ่มต้นของ Svelte
...
- คุณสมบัติ: ผสานรวมยูทิลิตี้โหมด เพิ่มเครื่องมือการเผยแพร่

### Fixed

- **release** — unblock release verification
...
- **Editor (Phase 3a)** — Three more features layered on top of Phase 2 plus a security/quality pass:
    ...
    - **URL prompt modal** — Image / YouTube / Link toolbar actions and slash commands now open a `svelora` `<Modal>` with `<Form>` + `<FormField>` for validation, loading state, and inline errors. Default URL schema enforces `http(s)://`; YouTube actions also enforce a YouTube-host regex.
...
[Unreleased]: https://github.com/asphum/svelora/compare/v3.2.6...HEAD
[3.2.6]: https://github.com/asphum/svelora/compare/v3.2.5...v3.2.6
[3.2.5]: https://github.com/asphum/svelora/compare/v3.2.4...v3.2.5
[3.2.4]: https://github.com/asphum/svelora/compare/v3.2.3...v3.2.4
[3.2.3]: https://github.com/asphum/svelora/compare/v3.2.2...v3.2.3
[3.2.2]: https://github.com/asphum/svelora/compare/v3.2.1...v3.2.2
...
[2.0.0]: https://github.com/asphum/svelora/compare/v1.8.0...v2.0.0
[1.6.0]: https://github.com/asphum/svelora/compare/v1.5.1...v1.6.0
[1.5.1]: https://github.com/asphum/svelora/compare/v1.5.0...v1.5.1
[1.5.0]: https://github.com/asphum/svelora/compare/v1.4.0...v1.5.0
[1.4.0]: https://github.com/asphum/svelora/compare/v1.3.0...v1.4.0
[1.3.0]: https://github.com/asphum/svelora/compare/v1.2.0...v1.3.0
[1.2.0]: https://github.com/asphum/svelora/compare/v1.1.0...v1.2.0
[1.1.0]: https://github.com/asphum/svelora/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/asphum/svelora/releases/tag/v1.0.0
